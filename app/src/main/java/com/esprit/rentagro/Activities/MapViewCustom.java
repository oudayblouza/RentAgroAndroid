...
/**
 * Created by oudayblouza on 09/12/2017.
 */
...
public class MapViewCustom extends MapView {
    ...
    public MapViewCustom(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }

    public MapViewCustom(Context context, GoogleMapOptions options) {
